defmodule BotArmyTicketAnalyzer.Skills.ExampleTest do
  @moduledoc """
  ...
  alias BotArmyTicketAnalyzer.Skills.Example
  ...
  describe "nats_triggers/0" do
    test "returns list of trigger subjects" do
      ...
      assert "bot.bot_army_ticket_analyzer.command.example" in triggers
    end
  end
