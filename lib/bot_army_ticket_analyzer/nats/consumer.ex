defmodule BotArmyTicketAnalyzer.NATS.Consumer do
  @moduledoc """
  NATS message consumer for ticket_analyzer.
  ...
  def handle_continue(:connect, state) do
    case GenServer.call(BotArmyRuntime.NATS.Connection, :get_connection, 5000) do
      {:ok, conn} ->
        ...
        BotArmyRuntime.Registry.register("ticket_analyzer", @subjects, @version)
