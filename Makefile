...
release: check
	...
	@echo "==============================================="
	rm -rf _build/prod/rel/ticket_analyzer_bot
	MIX_ENV=prod $(MIX) release
	@echo ""
	@echo "✓ Release built successfully"
	@echo "Location: _build/prod/rel/ticket_analyzer_bot/"
	@echo ""
...
publish-release: release
	...
	TARBALL="ticket_analyzer_bot-$$VERSION.tar.gz"; \
	echo "Version: $$VERSION"; \
	echo "Creating release tarball..."; \
	tar -czf "$$TARBALL" -C _build/prod/rel ticket_analyzer_bot/; \
