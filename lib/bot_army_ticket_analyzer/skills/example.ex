defmodule BotArmyTicketAnalyzer.Skills.Example do
  @moduledoc """
  Example skill for Ticket Analyzer Bot.
  ...
  1. NATS message arrives on trigger subject: `bot.bot_army_ticket_analyzer.command.example`
  ...
  5. Result published to response subject: `bot.bot_army_ticket_analyzer.response.<request_id>`
  ...
  1. Rename: `lib/bot_army_ticket_analyzer/skills/your_skill.ex`
  ...
  def nats_triggers do
    ...
    [
      "bot.bot_army_ticket_analyzer.command.example"
    ]
  end
