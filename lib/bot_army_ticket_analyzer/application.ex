defmodule BotArmyTicketAnalyzer.Application do
  @moduledoc """
  Ticket Analyzer Bot application supervisor.
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: BotArmyTicketAnalyzer.Supervisor]
  ...
  defp maybe_add_repo(children) do
    if @env == :test do
      ...
      [{BotArmyTicketAnalyzer.Repo, []} | children]
    end
  end
  ...
  defp maybe_add_pulse_publisher(children) do
    if @env == :test do
      ...
      [{BotArmyTicketAnalyzer.PulsePublisher, []} | children]
    end
  end
