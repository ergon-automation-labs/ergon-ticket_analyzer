defmodule BotArmyTicketAnalyzer.PulsePublisher do
  @moduledoc """
  Periodic health publisher for Ticket Analyzer Bot.
  ...
  2. **`bot.ticket_analyzer.pulse`** — richer metrics every 30 minutes (lower NATS volume).
  ...
  @service_name "ticket_analyzer"
  @envelope_source "bot_army_ticket_analyzer"
  ...
  @impl true
  def init(_opts) do
    Logger.info("[PulsePublisher] Starting Ticket Analyzer Bot pulse publisher")
